//import { filteringDirector } from '../src/data.js';
...
/*
describe('testing filteringDirector', () => {
  it('is a function', () => {
    expect(typeof filteringDirector).toBe('function');
  });

  it('filteringDirector returns selected option', () => {
    expect(filteringDirector(movies, "director", "Isao Takahata")).toStrictEqual([movies[3]]);
  });
});*/


/*
describe('testing orderingCharacters', () => {
  it('is a function', () => {
    expect(typeof ordering).toBe('function');
  });

  it('returns `A-Z`', () => {
    expect(ordering(movies,  "A-Z", "title")).toStrictEqual(moviesAZ);
  });
})
...
describe('anotherExample', () => {
  it('is a function', () => {
    expect(typeof orderingCharacters).toBe('function');
  });

  it('returns `anotherExample`', () => {
    expect(orderingCharacters()).toBe('OMG');
  });
});*/